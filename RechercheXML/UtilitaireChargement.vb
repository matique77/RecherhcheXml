...
Module UtilitaireChargement
    ...
    Public Function ChargerFichierXml(chemin As String) As DocumentXml
        ...
        End If
        'Permet de stocker de l'information dans de la classe déjà implémenter XmlDocument
        ...
        End Try
        'La racine de notre classe elementXml
        Dim maRacine As ElementXml
        doc.Load(chemin)
        'La racine de la classe déjà implémenter XmlElement
        ...
        'Permet de stocker de l'information dans notre classe DocumentXml
    ...
    Private Function AttributesVersList(maCollection As XmlAttributeCollection) As List(Of Attribut)
        'La liste qui stocks des attributs à retourner
    ...
    Private Function XmlChildVersClassRecursif(maCollection As XmlNodeList) As List(Of ElementXml)
        ...
        For Each element As XmlElement In maCollection
            'Le nouvelle elementXml qui sera ajouté à la liste.
